...
(
    ...
    `userId`     bigint(0)                                                     NULL     DEFAULT NULL COMMENT '上传标签者 id',
    `parentId`   bigint(0)                                                     NULL     DEFAULT NULL COMMENT '父标签 id',
    `level`      int(0)                                                        NULL     DEFAULT NULL COMMENT '标签层级 0 - 一级 1 - 二级 2 - 三级',
    `weights`    float(0)                                                      NULL     DEFAULT NULL COMMENT '权值',
