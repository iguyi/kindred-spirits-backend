...
public interface UserService extends IService<User> {
     ...
     * @return 符合要求的用户
     */
    List<User> searchUsersByTags(List<Long> friendIdList, List<String> tagNameList, Long pageSize, Long pageNum);
     ...
     * @return 符合要求的用户
     */
    List<User> searchUsersByTagsBySql(List<Long> friendIdList, List<String> tagNameList, Long pageSize, Long pageNum);
